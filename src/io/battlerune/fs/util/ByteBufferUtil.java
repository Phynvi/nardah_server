...
public final class ByteBufferUtil {
	...
	/**
	 * Gets a {@link String} from the specified {@link ByteBuffer}, the ByteBuffer
	 * will continue to get until the specified {@code terminator} is reached.
	 * <p>
	 * We use a {@link ByteArrayOutputStream} as it is self expanding. We don't want
	 * to waste precious time determining a fixed length for the {@code String}.
	 * </p>
	 * @param buffer The ByteBuffer to read from.
