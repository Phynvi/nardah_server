...
/**
 * A static-util class that provides additional functionality for generating
 ...
 * Surprisingly because of the way that {@code
 * ThreadLocalRandom} works, even in completely single-threaded situations it
 * runs up to three times faster than {@code
 * Random}.
