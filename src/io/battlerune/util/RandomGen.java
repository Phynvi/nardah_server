...
public final class RandomGen {
	 ...
	 * numbers. It is generally preferred to use this over {@link Random} because
	 * although {@code Random} is thread safe; the same seed is shared concurrently,
	 * which leads to contention between multiple threads and overhead as a result
	 * of that. Surprisingly because of the way that {@code ThreadLocalRandom}
	 * works, even in completely single-threaded situations it runs up to three
	 * times faster than {@code Random}.
	 * @see <a href=
	 * "http://java-performance.info/java-util-random-java-util-concurrent-threadlocalrandom-multithreaded-environments/">java.util.Random
	...
	/**
	 * Returns a pseudo-random {@code int} value between inclusive {@code min} and
	 * inclusive {@code max} excluding the specified numbers within the
	 * {@code excludes} array.
	 * @param min the minimum inclusive number.
	 * @param max the maximum inclusive number.
	 * @return the pseudo-random {@code int}.
	 ...
	 * @throws IllegalArgumentException If the specified range is less than
	 * {@code 0}.
	 */
	...
	/**
	 * An implementation of the Fisher-Yates shuffle algorithm that will shuffle the
	 * elements of an {@code T} array.
	...
	/**
	 * An implementation of the Fisher-Yates shuffle algorithm that will shuffle the
	 * elements of an {@code long} array.
	 * @param array the array that will be shuffled.
	 * @return the shuffled array.
	 */
	...
	/**
	 * An implementation of the Fisher-Yates shuffle algorithm that will shuffle the
	 * elements of an {@code double} array.
	 * @param array the array that will be shuffled.
	 * @return the shuffled array.
	 */
	...
	/**
	 * An implementation of the Fisher-Yates shuffle algorithm that will shuffle the
	 * elements of an {@code short} array.
	 * @param array the array that will be shuffled.
	 * @return the shuffled array.
	 */
	...
	/**
	 * An implementation of the Fisher-Yates shuffle algorithm that will shuffle the
	 * elements of an {@code byte} array.
	 * @param array the array that will be shuffled.
	 * @return the shuffled array.
	 */
	...
	/**
	 * An implementation of the Fisher-Yates shuffle algorithm that will shuffle the
	 * elements of an {@code float} array.
	 * @param array the array that will be shuffled.
	 * @return the shuffled array.
	 */
	...
	/**
	 * An implementation of the Fisher-Yates shuffle algorithm that will shuffle the
	 * elements of an {@code boolean} array.
	 * @param array the array that will be shuffled.
	 * @return the shuffled array.
	 */
	...
	/**
	 * An implementation of the Fisher-Yates shuffle algorithm that will shuffle the
	 * elements of an {@code char} array.
	 * @param array the array that will be shuffled.
	 */
	...
	/**
	 * Determines if a pseudorandomly generated double rounded to two decimal places
	 * is below or equal to {@code value}.
