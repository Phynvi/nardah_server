...
public final class HighscoreService {
	...
	public static void saveHighscores(Player player) {
		if(player == null || !Config.LIVE_SERVER || !Config.FORUM_INTEGRATION || PlayerRight.isPriviledged(player) || !Config.highscoresEnabled) {
			return;
		}
		
		logger.info("Updating highscores for " + player.getUsername());
		new Thread(() -> {
