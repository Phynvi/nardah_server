...
public class CombatConstants {
	 ...
	 */
	public static final int COMBAT_TIMER_COOLDOWN = 8_000;
	...
	public static final String[] SKILL_REQUIREMENT_CONFIG_FIELD_NAMES = {"req-attack", "req-defence", "req-strength", "req-hitpoints", "req-ranged", "req-prayer", "req-magic", "req-cooking", "req-woodcutting", "req-fletching", "req-fishing", "req-firemaking", "req-crafting", "req-smithing", "req-mining", "req-herblore", "req-agility", "req-thieving", "req-slayer", "req-farming", "req-runecrafting", "req-construction", "req-hunter"};
	...
	public static final String[] BONUS_CONFIG_FIELD_NAMES = {
			...
			// Other bonuses
			"bonus-strength", "ranged-strength", "magic-damage", "bonus-prayer"};
	
	public static final String[] SKILL_FIELD_NAMES = {"attack-level", "defence-level", "strength-level", "hitpoints-level", "ranged-level", "prayer-level", "magic-level"};
