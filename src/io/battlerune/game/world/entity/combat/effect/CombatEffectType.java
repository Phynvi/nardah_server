...
public enum CombatEffectType {
	POISON(new CombatPoisonEffect()), VENOM(new CombatVenomEffect()), SKULL(new CombatSkullEffect()), TELEBLOCK(new CombatTeleblockEffect()), ANTIFIRE_POTION(new CombatAntifireEffect(AntifireDetails.AntifireType.REGULAR)), SUPER_ANTIFIRE_POTION(new CombatAntifireEffect(AntifireDetails.AntifireType.SUPER));
