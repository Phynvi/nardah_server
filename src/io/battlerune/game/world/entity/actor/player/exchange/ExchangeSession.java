package io.battlerune.game.world.entity.actor.player.exchange;

import com.google.common.collect.ImmutableSet;
import io.battlerune.content.activity.ActivityType;
import io.battlerune.game.task.impl.DuelNotificationTask;
import io.battlerune.game.task.impl.SessionRemovalNotificationTask;
...
public abstract class ExchangeSession {
	...
	/**
	 * The attachment to the session stage, this will more than likely be a player
	 * object that will be attached when they have confirmed a certain stage.
	 */
	...
	/**
	 * Determines if the player is a session with {@code other} which matches the
	 * {@code type}.
	 */
	...
	/**
	 * Finalizes the exchange session procedure for the specified {@code player} in
	 * a session.
	 */
