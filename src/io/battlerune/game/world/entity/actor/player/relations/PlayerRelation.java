package io.battlerune.game.world.entity.actor.player.relations;
	...
	public PlayerRelation updateLists(boolean online) {
		...
		for(Player players : World.getPlayers()) {
			...
			if(players.relations.friendList.contains(player.usernameLong)) {
				if(privateChatMode.equals(PrivacyChatMode.FRIENDS_ONLY) && !friendList.contains(players.usernameLong) || privateChatMode.equals(PrivacyChatMode.OFF) || ignoreList.contains(players.usernameLong)) {
			...
			if(player.relations.friendList.contains(players.usernameLong)) {
				if(players.relations.privateChatMode.equals(PrivacyChatMode.FRIENDS_ONLY) && !players.relations.getFriendList().contains(player.usernameLong) || players.relations.privateChatMode.equals(PrivacyChatMode.OFF) || players.relations.getIgnoreList().contains(player.usernameLong)) {
					tempOn = false;
				}
