package io.battlerune.game.world.entity.actor.data;
...
import static io.battlerune.content.activity.ActivityType.TUTORIAL;
	...
	COMBAT {
		...
		public boolean exception(Actor actor, Object object) {
			...
			if(StarterKitButtonPlugin.isButton(button))
				return true;
			if(actor.inActivity(TUTORIAL) && EventDispatcher.execute(actor.getPlayer(), new ClickButtonInteractionEvent(button)))
				return true;
