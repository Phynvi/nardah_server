package io.battlerune.game.world.entity.actor.movement;

import io.battlerune.game.world.Interactable;
import io.battlerune.game.world.entity.actor.Direction;
import io.battlerune.game.world.entity.actor.Actor;
import io.battlerune.game.world.pathfinding.distance.Manhattan;
import io.battlerune.game.world.pathfinding.path.Path;
import io.battlerune.game.world.pathfinding.path.impl.AStarPathFinder;
import io.battlerune.game.world.pathfinding.path.impl.DijkstraPathFinder;
import io.battlerune.game.world.pathfinding.path.impl.SimplePathFinder;
