...
public enum PlayerRight {
	PLAYER("Player", "000000", 0, -1, 4111), MODERATOR("Moderator", "245EFF", 1, -1, 4116), ADMINISTRATOR("Administrator", "D17417", 2, -1, 4116), OWNER("Owner", "ED0C0C", 3, -1, 4117), DEVELOPER("Developer", "7D0CED", 4, -1, 4117),
	
	DONATOR("Donator", "9C4B2F", 5, 10, 4112), SUPER_DONATOR("Super Donator", "2F809C", 6, 50, 4112), EXTREME_DONATOR("Extreme Donator", "158A76", 7, 250, 4113), ELITE_DONATOR("Elite Donator", "2CA395", 8, 500, 4114), KING_DONATOR("King Donator", "E32973", 9, 1000, 4115), SUPREME_DONATOR("Supreme Donator", "9C4B2F", 10, 1500, 4115),
	
	VETERAN("Veteran", "B1800A", 10, -1, 4115), YOUTUBER("Youtuber", "91111A", 11, -1, 4112), IRONMAN("Ironman", "7A6F74", 12, -1, 4112), ULTIMATE_IRONMAN("Ultimate Ironman", "7A6F74", 13, -1, 4113), HARDCORE_IRONMAN("Hardcore Ironman", "7A6F74", 14, -1, 4114), HELPER("Helper", "5C5858", 16, -1, 4115), GRAPHIC("Graphic", "CE795A", 17, -1, 4112);
