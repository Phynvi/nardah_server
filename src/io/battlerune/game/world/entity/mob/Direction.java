package io.battlerune.game.world.entity.mob;
...
public enum Direction {
	NORTH(0, 1), NORTH_EAST(1, 1), EAST(1, 0), SOUTH_EAST(1, -1), SOUTH(0, -1), SOUTH_WEST(-1, -1), WEST(-1, 0), NORTH_WEST(-1, 1), NONE(0, 0);
	...
	/**
	 * Gets the Manhattan direction of an orientation. Manhattan direction does not
	 * support diagnal directions, so the orientation must be between [0, 3]
	 * inclusive.
	 * @param orientation
	 * @return
	 */
