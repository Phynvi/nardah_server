...
public enum Plants {
	...
	POTATO(5318, 1942, 6, 0, 0, 1, 7, SeedType.ALLOTMENT, 8, 9, 4), ONION(5319, 1957, 13, 0, 0, 5, 7, SeedType.ALLOTMENT, 9, 10, 4), CABBAGE(5324, 1967, 20, 0, 0, 7, 7, SeedType.ALLOTMENT, 10, 11, 4), TOMATO(5322, 1982, 27, 0, 0, 12, 7, SeedType.ALLOTMENT, 12, 14, 4), SWEETCORN(5320, 5986, 34, 0, 0, 20, 7, SeedType.ALLOTMENT, 17, 19, 6), STRAWBERRY(5323, 5504, 43, 0, 0, 31, 6, SeedType.ALLOTMENT, 26, 29, 6), WATERMELON(5321, 5982, 52, 0, 0, 47, 4, SeedType.ALLOTMENT, 48, 54, 8),

	MARIGOLD(5096, 6010, 8, 0, 0, 2, 7, SeedType.FLOWER, 8, 47, 4), ROSEMARY(5097, 6014, 13, 0, 0, 11, 7, SeedType.FLOWER, 12, 66, 4), NASTURTIUM(5098, 6012, 18, 0, 0, 24, 7, SeedType.FLOWER, 19, 111, 4), WOAD(5099, 5738, 23, 0, 0, 25, 7, SeedType.FLOWER, 20, 115, 4), LIMPWURT(5100, 225, 28, 0, 0, 26, 7, SeedType.FLOWER, 21, 120, 4),//156
	...
	private Plants(int seed, int harvest, int config, int diseased, int dead, int level, int minutes, SeedType type, double plantExperience, double harvestExperience, int stages) {
		this.seed = seed;
