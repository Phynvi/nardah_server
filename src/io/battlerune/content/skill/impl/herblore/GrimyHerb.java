...
public enum GrimyHerb {
	GUAM(199, 249, 1, 2.5), MARRENTILL(201, 251, 5, 3.8), TARROMIN(203, 253, 11, 5), HARRALANDER(205, 255, 20, 6.3), RANARR(207, 257, 25, 7.5), TOADFLAX(3049, 2998, 30, 8), SPIRITWEED(12174, 12172, 35, 8), IRIT(209, 259, 40, 8.8), WERGALI(14836, 14854, 30, 8), AVANTOE(211, 261, 48, 10), KWUARM(213, 263, 54, 11.3), SNAPDRAGON(3051, 3000, 59, 11.8), CADANTINE(215, 265, 65, 12.5), LANTADYME(2485, 2481, 67, 13.1), DWARFWEED(217, 267, 70, 13.8), TORSTOL(219, 269, 75, 15);
