...
import static io.battlerune.content.skill.impl.magic.teleport.Teleportation.TeleportationData.MODERN;
...
public class TutorialActivity extends Activity {
	...
	protected void start() {
		...
		switch(stage) {
			case 0:
				guide = new Npc(306, new Position(3222, 3221));
				add(guide);
			...
			case 17:
				...
				break;
			case 18:
				factory.sendNpcChat(306, "These npcs can really help you out, anywhere from", "mass decanting potions, changing appearances,", "buying skillcapes and more!").onAction(this::next).execute();
				pause();
				break;
			case 19:
