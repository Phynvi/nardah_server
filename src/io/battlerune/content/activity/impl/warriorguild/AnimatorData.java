...
public enum AnimatorData {
	SOUTH_WEST(new Position(2851, 3536), new Position(2851, 3537), new Position(2851, 3541)), SOUTH_EAST(new Position(2857, 3536), new Position(2857, 3537), new Position(2857, 3541)), NORTH_WEST(new Position(2853, 3552), new Position(2853, 3551), new Position(2853, 3547)), NORTH_EAST(new Position(2857, 3552), new Position(2857, 3551), new Position(2857, 3547));
