...
public class RangingApp {
	...
	public enum RangeApplication {
		...
		Range6(60, new Item(11235)), Range7(65, new Item(12424)), Range8(70, new Item(4214)), Range9(75, new Item(20997)), Range11(99, new Item(9757)); // 99CAPE
	...
	public static void open(Player player) {
		if(player.getCombat().inCombat()) {
			...
			player.send(new SendString("Near-Reality Range Guide", 37103));
