...
public class DefenceApp {
	...
	public enum DefenceApplication {
		...
		Defence30(65, new Item(11832)), Defence40(70, new Item(4720)), Defence70(70, new Item(12831)), Defence71(75, new Item(11283)), Defence75(75, new Item(21015)), Defence99(99, new Item(9754)); // 99CAPE
	...
	public static void open(Player player) {
		if(player.getCombat().inCombat()) {
			...
			player.send(new SendString("Runity Defence Guide", 37103));
