...
public class MagicApp {
	...
	public enum MagicApplication {
		...
		Magic6(42, new Item(6916)), Magic7(50, new Item(2413)), Magic8(60, new Item(9079)), Magic9(65, new Item(10338)), Magic10(65, new Item(12002)), Magic11(70, new Item(4712)), Magic12(70, new Item(13235)), Magic13(75, new Item(21021)), Magic14(75, new Item(9763)); // 99CAPE
	...
	public static void open(Player player) {
		if(player.getCombat().inCombat()) {
			...
			player.send(new SendString("Runity Magic Guide", 37103));
