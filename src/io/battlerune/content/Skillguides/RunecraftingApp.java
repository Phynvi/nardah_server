package io.battlerune.content.Skillguides;
...
public class RunecraftingApp {
	...
	public enum RunecraftApp {
		...
		Runecrafting6(27, new Item(562)), Runecrafting7(35, new Item(11699)), Runecrafting8(40, new Item(11693)), Runecrafting9(44, new Item(11695)), Runecrafting10(54, new Item(11692)), Runecrafting11(65, new Item(11697)), Runecrafting12(77, new Item(11698)), Runecrafting13(90, new Item(11698)), // This needs to be changed to wrath runes
	...
	public static void open(Player player) {
		if(player.getCombat().inCombat()) {
			...
			for(int index = 0, string = 37116; index < size; index++) {
				...
				int amount = player.skillmenuLevel == 0 ? perk.getReward().getAmount() : perk.getReward().getAmount() * player.skillmenuLevel;
			...
			player.send(new SendString("As a player raises their Runecrafting. They can create higher tier runes.", 37112));
			...
			player.send(new SendString("Runity Runecrafting Guide", 37103));
