...
public enum ClanRank {
	MEMBER("Member", -1), FRIEND("Friend", 0), RECRUIT("Recruit", 1), CORPORAL("Corporal", 2), SERGEANT("Sergeant", 3), LIEUTENANT("Lieutenant", 4), CAPTAIN("Captain", 5), GENERAL("General", 6), LEADER("Leader", 7), SYSTEM("System", 8);
