...
import io.battlerune.content.writer.impl.ObeliskWriter;
...
import io.battlerune.game.world.position.Boundary;
...
public class Obelisks {
	...
	public enum ObeliskData {
		LEVEL_13(14829, new Boundary(3154, 3618, 3158, 3622)), LEVEL_19(14830, new Boundary(3225, 3665, 3229, 3669)), LEVEL_27(14827, new Boundary(3033, 3730, 3037, 3734)), LEVEL_35(14828, new Boundary(3104, 3792, 3108, 3796)), LEVEL_44(14826, new Boundary(2978, 3864, 2982, 3868)), LEVEL_50(14831, new Boundary(3305, 3914, 3309, 3918));
