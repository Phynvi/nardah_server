...
import static io.battlerune.content.store.currency.CurrencyType.COINS;
...
public class SkillcapeStore extends Store {
	...
	public void refresh(Player player) {
		player.send(new SendString((currencyType == COINS ? "Coins" : "Points") + ": " + CurrencyType.getValue(player, currencyType), 40008));
