...
public enum PrestigePerk {
	ARROWHEAD("Arrowhead", "Using arrows will not break.", 6798), MASTERBAIRTER("Masterbaiter", "15% chance of catching extra fish.", 6799), DOUBLE_WOOD("Double wood", "15% chance to receive an additional log.", 6800), LITTLE_BIRDY("Little Birdy", "Increase the woodcutting rate of bird nest drops by 15%.", 6801), THE_ROCK("The Rock", "10% chance to receive an additional ore.", 6802), FLAME_ON("Flame On", "25% chance of burning an extra log.", 6803),
	;
