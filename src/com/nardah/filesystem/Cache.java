...
public final class Cache {
	...
	/**
	 * Represents the size of a index file. Calculating the total size of a index
	 * file. the total size may be that of a {@code long}.
	 */
	public static final int INDEX_SIZE = 6;
	
	/**
	 * Represents the size of a {@link Sector}s header. Calculating the total size
	 * of the sector header. the total size may be that of a {@code long}.
	 */
	 ...
	 * <p>
	 * This byte buffer is used to read index and sector data from their respective
	 * byte channels.
	 * </p>
	 */
	...
	/**
	 * Constructs a new {@link Cache} with the specified sector and index channels
	 * and id.
	...
	/**
	 * Gets a {@link ByteBuffer} of data within this cache for the specified index
	 * id.
