...
public final class Sector {
	...
	/**
	 * Constructs a new {@link Sector} with the expected index id, chunk, next index
	 * id and cache id. This constructor is marked {@code private} and should not be
	 * modified to be invoked directly, use
