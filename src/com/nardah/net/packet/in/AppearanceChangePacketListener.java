...
public final class AppearanceChangePacketListener implements PacketListener {
	...
	public void handlePacket(Player player, GamePacket packet) {
		...
		final Appearance appearance = new Appearance(gender == 0 ? Gender.MALE : Gender.FEMALE, head, gender == 0 ? jaw : -1, torso, arms, hands, legs, feet, hairColor, torsoColor, legsColor, feetColor, skinColor);

		if(!isValid(player, appearance)) {
			return;
		}
	...
	private static boolean isValid(Player player, Appearance appearance) {
