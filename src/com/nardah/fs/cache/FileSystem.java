...
public final class FileSystem {
	...
	/**
	 * Represents the id of the word archive - user for storing profane or illegal
	 * words not allowed to be spoken in-game.
	 */
	 ...
	 * @param archives All of the {@link Archive}s within this {@link FileSystem}.
	 */
	...
	/**
	 * Gets an {@link Archive} for the specified {@code id}, this method fails-fast
	 * if no archive can be found.
	...
	/**
	 * Gets a {@link Cache} for the specified {@code id}, this method fails-fast if
	 * no cache can be found.
	...
	/**
	 * Returns a {@link ByteBuffer} of file data for the specified index within the
	 * specified {@link Cache}.
	...
	/**
	 * Returns the cached {@link #archiveHashes} if they exist, otherwise they are
