...
public final class ActionManager {
	...
	/**
	 * Sequences the pending actions, and as soon as the current action has stopped,
	 * it executes the head of the queue.
	 */
	...
	/**
	 * Cancels all the queued actions by stopping them and removing all elements
	 * from the queue.
	 */
