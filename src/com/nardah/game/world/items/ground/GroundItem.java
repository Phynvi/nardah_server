...
import com.nardah.game.event.impl.log.DropItemLogEvent;
...
import com.nardah.net.packet.out.SendRemoveGroundItem;
...
public final class GroundItem extends Entity {
	...
	public void addToRegion(Region region) {
		...
		if(groundItem != null && groundItem.item.isStackable() && policy.equals(groundItem.policy) && (policy == GroundItemPolicy.GLOBAL || player.usernameLong == groundItem.player.usernameLong)) {
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof GroundItem) {
			...
			return other.getPosition().equals(getPosition()) && other.item.equals(item) && player.usernameLong == other.player.usernameLong;
		}
		return false;
	}
