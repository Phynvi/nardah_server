package com.nardah.game.world.items.containers.impl;
	...
	public void depositMenu(Item item) {
		player.dialogueFactory.sendOption("1", () -> {
			...
			player.dialogueFactory.onAction(() -> {
				player.send(new SendInputMessage("Enter the amount you would like to deposit into the looting bag:", 12, input -> {
