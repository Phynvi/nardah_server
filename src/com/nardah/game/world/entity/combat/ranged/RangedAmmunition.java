...
public enum RangedAmmunition {
	BRONZE_JAVELIN(false, 825, 831, 5642, 5648) {
		...
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Bronze javelin");
		}
	}, IRON_JAVELIN(false, 826, 832, 5643, 5649) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Iron javelin");
		}
	}, STEEL_JAVELIN(false, 827, 833, 5644, 5650) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Steel javelin");
		}
	}, MITHRIL_JAVELIN(false, 828, 834, 5645, 5651) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Mithril javelin");
		}
	}, ADAMANT_JAVELIN(false, 829, 835, 5646, 5652) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Adamant javelin");
		}
	}, RUNE_JAVELIN(false, 830, 836, 5647, 5653) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Rune javelin");
		}
	}, DRAGON_JAVELIN(false, 19484, 19486, 19488, 19490) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Dragon javelin");
		}
	},
	...
	BRONZE_THROWNAXE(true, 800) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Bronze thrownaxe");
		}
	}, IRON_THROWNAXE(true, 801) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Iron thrownaxe");
		}
	}, STEEL_THROWNAXE(true, 802) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Steel thrownaxe");
		}
	}, MITHRIL_THROWNAXE(true, 803) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Mithril thrownaxe");
		}
	}, ADAMANT_THROWNAXE(true, 804) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Adamant thrownaxe");
		}
	}, RUNE_THROWNAXE(true, 805) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Rune thrownaxe");
		}
	}, DRAGON_THROWNAXE(true, 20849) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Dragon thrownaxe");
		}
	},
	...
	BRONZE_DART(true, 806, 812, 5628, 5635) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Bronze dart");
		}
	}, IRON_DART(true, 807, 813, 5629, 5636) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Iron dart");
		}
	}, BLACK_DART(true, 3093, 3094, 5631, 5638) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Black dart");
		}
	}, STEEL_DART(true, 808, 814, 5630, 5637) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Steel dart");
		}
	}, MITHRIL_DART(true, 809, 815, 5632, 5639) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Mithril dart");
		}
	}, ADAMANT_DART(true, 810, 816, 5633, 5640) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Adamant dart");
		}
	}, RUNE_DART(true, 811, 817, 5634, 5641) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Rune dart");
		}
	}, DRAGON_DART(true, 11230, 11231, 11233, 11234) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Dragon dart");
		}
	},
	...
	BRONZE_KNIFE(true, 864, 870, 5654, 5651) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Bronze knife");
		}
	}, IRON_KNIFE(true, 863, 871, 5655, 5662) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Iron knife");
		}
	}, BLACK_KNIFE(true, 869, 874, 5658, 5665) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Black knife");
		}
	}, STEEL_KNIFE(true, 865, 872, 5656, 5663) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Steel knife");
		}
	}, MITHRIL_KNIFE(true, 866, 873, 5657, 5664) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Mithril knife");
		}
	}, ADAMANT_KNIFE(true, 867, 875, 5659, 5666) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Adamant knife");
		}
	}, RUNE_KNIFE(true, 868, 876, 5660, 5667) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Rune knife");
		}
	},
	...
	DOUBLE_BRONZE_ARROW(true, darkBows(), 882, 883, 5616, 5622) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Bronze arrow");
		}
	}, DOUBLE_IRON_ARROW(true, darkBows(), 884, 885, 5617, 5623) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Iron arrow");
		}
	}, DOUBLE_STEEL_ARROW(true, darkBows(), 886, 887, 5618, 5624) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Steel arrow");
		}
	}, DOUBLE_MITHRIL_ARROW(true, darkBows(), 888, 889, 5619, 5625) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Mithril arrow");
		}
	}, DOUBLE_ADAMANT_ARROW(true, darkBows(), 890, 891, 5620, 5626) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Adamant arrow");
		}
	}, DOUBLE_RUNE_ARROW(true, darkBows(), 892, 893, 5621, 5627) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Rune arrow");
		}
	}, DOUBLE_DRAGON_ARROW(true, darkBows(), 11212, 11227, 11228, 11229) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Dragon arrow");
		}
	},
	...
	BRONZE_BOLTS(true, 877, 878, 6061, 6062, 879, 9236) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Bronze bolts");
		}
	}, BLURITE_BOLTS(true, 9139, 9286, 9293, 9300, 9335, 9237) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Blurite bolts");
		}
	}, IRON_BOLTS(true, 9140, 9287, 9294, 9301, 880, 9238) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Iron bolts");
		}
	}, SILVER_BOLTS(true, 9145, 9292, 9299, 9306) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Silver bolts");
		}
	}, STEEL_BOLTS(true, 9141, 9288, 9295, 9302, 9336, 9239) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Steel bolts");
		}
	}, MITHRIL_BOLTS(true, 9142, 9289, 9296, 9303, 9337, 9240, 9338, 9241) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Mithril bolts");
		}
	}, ADAMANT_BOLTS(true, 9143, 9290, 9297, 9304, 9339, 9242, 9340, 9243) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Adamant bolts");
		}
	}, RUNITE_BOLTS(true, 9144, 9291, 9298, 9305, 9341, 9244, 9342, 9245, 10159, 10158) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Runite bolts");
		}
	},
	...
	BRUTAL_BRONZE_ARROW(true, 4773) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Bronze brutal");
		}
	}, BRUTAL_IRON_ARROW(true, 4778) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Iron brutal");
		}
	}, BRUTAL_BLACK_ARROW(true, 4783) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Steel brutal");
		}
	}, BRUTAL_STEEL_ARROW(true, 4788) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Black brutal");
		}
	}, BRUTAL_MITHRIL_ARROW(true, 4793) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Mithril brutal");
		}
	}, BRUTAL_ADAMANT_ARROW(true, 4798) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Adamant brutal");
		}
	}, BRUTAL_RUNE_ARROW(true, 4803) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Rune brutal");
		}
	},
	...
	TOKTZ_XIL_UL(true, 6522) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Toktz-xil-ul");
		}
	}, BONE_BOLT(true, 8882) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Bone bolts");
		}
	}, OGRE_ARROW(true, 2866) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Ogre arrow");
		}
	}, ICE_ARROW(true, 78) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Ice arrows");
		}
	}, TRAINING_ARROWS(true, 9706) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Training arrows");
		}
	}, BOLT_RACK(false, 4740) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Bolt rack");
		}
	},
	...
	BROAD_TIPPED_BOLTS(true, 13280) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Broad-tipped bolts");
		}
	}, BROAD_ARROW(true, 4160) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Broad arrow");
		}
	},
	...
	CHINCHOMPA(false, 10033) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Chinchompa");
		}
	}, RED_CHINCHOMPA(false, 10034, 11959) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Red chinchompa");
		}
	},
	...
	KEBBIT_BOLT(true, 10158) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Kebbit bolts");
		}
	}, LONG_KEBBIT_BOLT(true, 10159) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Long kebbit bolts");
		}
	},
	...
	GUAM_TAR(false, 10142) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Guam tar");
		}
	}, MARRENTIL_TAR(false, 10143) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Marrentill tar");
		}
	}, TARROMIN_TAR(false, 10144) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Tarromin tar");
		}
	}, HARRALANDER_TAR(false, 10145) {
		@Override
		protected CombatProjectile getProjectile() {
			return CombatProjectile.getDefinition("Harralander tar");
		}
	};
	...
	protected abstract CombatProjectile getProjectile();
	...
	public Optional<Graphic> getStart(int id) {
		switch(id) {
			...
			case 10159:
			case 10158:
				return CombatProjectile.getDefinition(new Item(id).getName()).getStart();
		}
		int itemId;
		switch(this) {
			case DOUBLE_BRONZE_ARROW:
	...
	public Optional<Animation> getAnimation(int id) {
		switch(id) {
			...
			case 10159:
			case 10158:
				return CombatProjectile.getDefinition(new Item(id).getName()).getAnimation();
		}
	...
	public Optional<Graphic> getEnd(int id) {
		switch(id) {
			...
			case 10159:
			case 10158:
				return CombatProjectile.getDefinition(new Item(id).getName()).getEnd();
		}
	...
	public Optional<CombatImpact> getEffect(int id) {
		switch(id) {
			...
			case 10159:
			case 10158:
				return CombatProjectile.getDefinition(new Item(id).getName()).getEffect();
		}
