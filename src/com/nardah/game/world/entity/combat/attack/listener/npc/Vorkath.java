...
public class Vorkath {// extends SimplifiedListener<Mob> {
	/*
	 *
	 ...
	 * victim) { Mob dragon = (Mob) entity; if (dragon.isChargingAttack() ||
	 ...
	 * dragon.performAnimation(up); Position savew = victim.getPosition(); Mob
	 * position = new Mob(1, victim.getPosition()); World.register(target,
