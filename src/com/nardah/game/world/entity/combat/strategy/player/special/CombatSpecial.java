package com.nardah.game.world.entity.combat.strategy.player.special;

import com.nardah.content.activity.Activity;
import com.nardah.game.world.entity.combat.strategy.player.special.melee.*;
import com.nardah.game.world.entity.combat.strategy.player.special.range.*;
...
public enum CombatSpecial {
	/* Abyssal **/
	ABYSSAL_WHIP(new int[]{4151, 21371, 15441, 15442, 15443, 15444}, 50, AbyssalWhip.get()), ABYSSAL_TENTACLE_WHIP(new int[]{12006}, 50, AbyssalTentacleWhip.get()), ABYSSAL_DAGGER(new int[]{13265, 13267, 13271, 13269}, 50, AbyssalDagger.get()), ABYSSAL_BLUDGEN(new int[]{13263}, 50, AbyssalBludgen.get()),
	
	/* Dragon **/
	DRAGON_DAGGER(new int[]{1215, 1231, 5680, 5698}, 25, DragonDagger.get()), DRAGON_WARHAMMER(new int[]{13576}, 50, DragonWarhammer.get()), DRAGON_LONGSWORD(new int[]{1305}, 25, DragonLongsword.get()), DRAGON_SCIMITAR(new int[]{4587}, 55, DragonScimitar.get()), DRAGON_SWORD(new int[]{21206}, 40, DragonSword.get()), DRAGON_HALBERD(new int[]{3204}, 30, DragonHaldberd.get()), DRAGON_CLAWS(new int[]{13652, 20784}, 50, DragonClaws.get()), DRAGON_SPEAR(new int[]{1249, 1263, 5730, 3176, 5716, 11824, 11889}, 25, DragonSpear.get()), DRAGON_MACE(new int[]{1434}, 25, DragonMace.get()), DRAGON_2H(new int[]{7158}, 60, Dragon2h.get()), ANICENT_MACE(new int[]{11061}, 100, AnicentMace.get()),
	...
	/* Ranged **/
	BLOW_PIPE(new int[]{12926}, 50, Blowpipe.get()), DARK_BOW(new int[]{11235, 12765, 12766, 12767, 12768}, 55, DarkBow.get()), MAGIC_SHORTBOW(new int[]{861, 12788}, 55, MagicShortbow.get()), BALLISTA(new int[]{19478, 19481}, 55, Ballista.get()), ARMADYL_CROSSBOW(new int[]{11785}, 40, ArmadylCrossbow.get()), DRAGON_THROWNAXE(new int[]{20849}, 25, DragonThrownaxe.get()) {
		@Override
		public void enable(Player player) {
			super.enable(player);
	...
	/* Other **/
	SARADOMIN_SWORD(new int[]{11838, 12809}, 100, SaradominSword.get()), STAFF_OF_THE_DEAD(new int[]{11791, 12904}, 100, DefaultMelee.get()) {
		@Override
		public void enable(Player player) {
			if(player.getSpecialPercentage().intValue() < player.getCombatSpecial().getAmount()) {
				player.send(new SendMessage("You do not have enough special energy left!"));
