...
public class GanoUtility {
	...
	public static Mob generateSpawn() {
	...
	public static void GeneratedLoot(Mob gano, Player player) {
	
	}
	
	public static void defeated(Mob gano, Player player) {
		...
		if(hasClan) {
			...
			World.sendMessage("<col=8714E6> gano has been defeated by " + player.getName() + ", a clan member of " + player.clanChannel.getName() + "!");
			player.clanChannel.message("Hell yeah boys! We just killed gano!! We earned 10,000 EXP & 5 CP.");
		} else {
			World.sendMessage("<col=8714E6> gano has been defeated by " + player.getName() + ", a solo individual with balls of steel!");
	...
	public enum SpawnData {
		LEVEL_18("lvl 18 wild near east dragons", new Position(3307, 3668, 0)), LEVEL_19("lvl 19 wild near obelisk", new Position(3222, 3658, 0)), LEVEL_28("lvl 28 wild near vennenatis", new Position(3308, 3737, 0)), LEVEL_41("lvl 41 wild near callisto", new Position(3270, 3843, 0)), LEVEL_52("lvl 52 wild near obelisk", new Position(3304, 3929, 0)), LEVEL_53("lvl 53 wild near scorpia's cave entrance", new Position(3211, 3944, 0));
