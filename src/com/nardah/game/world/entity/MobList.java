package com.nardah.game.world.entity;
...
public final class MobList<E extends Actor> implements Iterable<E> {
	...
	public static final class EntityListIterator<E extends Actor> implements Iterator<E> {
		 ...
		 * @param list The {@link MobList} this {@link Iterator} is dedicated to.
		 */
	 ...
	 * <p>
	 * UPDATED: Now uses a shuffle_list to battle PID. This means that all entities
	 * are always processed in an random order instead of having higher priority
	 * than other entities because of a higher PID.
	 */
	@Override
	...
	/**
	 * Removes {@code entity} from this list. Will throw an exception if the entity
	...
	/**
	 * Retrieves the element on {@code index}, the only difference between this and
	 * {@code get(int)} is that this method throws an exception if no entity is
	 * found on {@code index}.
	 * @param index The index.
	...
	/**
	 * @return The {@link Stream} that will traverse over this list. Automatically
	 * excludes {@code null} values.
	 */
