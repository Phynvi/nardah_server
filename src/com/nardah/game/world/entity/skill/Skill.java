...
public class Skill implements InteractionEventListener {
	 ...
	 */
	private static final String[] SKILL_NAMES = new String[]{ /* 00 */ "Attack", /* 01 */ "Defence",
			...
			/* 21 */ "Construction", /* 22 */ "Hunter",};
	
	/**
	 * An array with the index being the skill level (from [0, 99]) and the value
	 * being the minimum experience requirement for that level.
	 */
	 ...
	 */
	public static final int[][] INTERFACE_DATA = {{4004, 4005}, {4008, 4009}, {4006, 4007}, {4016, 4017}, {4010, 4011}, {4012, 4013}, {4014, 4015}, {4034, 4035}, {4038, 4039}, {4026, 4027}, {4032, 4033}, {4036, 4037}, {4024, 4025}, {4030, 4031}, {4028, 4029}, {4020, 4021}, {4018, 4019}, {4022, 4023}, {12166, 12167}, {13926, 13927}, {4152, 4153}, {-1, -1}, {24134, 24135}, {-1, -1}, {-1, -1}};
	...
	/**
	 * Modifies the current level with a given function. The level will be clipped
	 * to the given boundaries as well.If the level happens to fall under 0, the
	 * level will be set to 0, regardless of the given boundaries.
	 * @param function The function, with this current skill level as the input,
	 * and the new level as an output.
	 ...
	 * @param function The function, with this current skill experience as the
	 * input, and the new experience as an output.
	 */
	...
	/**
	 * Modifies the current experience with a given function. The experience will be
	 * clipped to the given boundaries as well. If the experience happens to fall
	 * under 0, the experience will be set to 0, regardless of the given boundaries.
	 * @param function The function, with this current skill experience as the
	 * input, and the new experience as an output.
	...
	/**
	 * Gets the level for a given experience amount. If the experience is larger
	 * than the experience at level 99, then the value will always return 99.
	 */
	...
	/**
	 * Gets the experience for a given level. The level is automatically clipped to
