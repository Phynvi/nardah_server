...
import com.nardah.game.action.ActionManager;
import com.nardah.game.world.entity.actor.data.LockType;
import com.nardah.game.world.entity.actor.move.Movement;
import com.nardah.game.world.entity.actor.move.waypoint.CombatWaypoint;
import com.nardah.game.world.entity.actor.move.waypoint.FollowWaypoint;
import com.nardah.game.world.entity.actor.move.waypoint.WalkToWaypoint;
...
import com.nardah.game.world.entity.skill.SkillManager;
import com.nardah.game.world.object.GameObject;
import com.nardah.game.world.position.Position;
import com.nardah.util.MutableNumber;
import com.nardah.util.Utility;
import com.nardah.util.generic.BooleanInterface;
...
public abstract class Actor extends Entity {
	...
	private int[] bonuses = CombatConstants.EMPTY_BONUSES;
	 ...
	 * Check if an entity is an mob.
	 */
	public final boolean isNpc(BooleanInterface<Mob> condition) {
	...
	public void appendBonus(int index, int amount) {
		if(bonuses == CombatConstants.EMPTY_BONUSES)
			bonuses = new int[CombatConstants.EMPTY_BONUSES.length];
