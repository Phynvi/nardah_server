...
public class ActorAnimation {
	...
	ActorAnimation(EnumSet<UpdateFlag> updateFlags) {
	...
	public void setNpcAnimations(MobDefinition definition) {
	...
	public ActorAnimation copy() {
		ActorAnimation other = new ActorAnimation(updateFlags);
		other.stand = stand;
		other.turn = turn;
		other.walk = walk;
