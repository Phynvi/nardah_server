...
import com.nardah.game.world.pathfinding.distance.Distance;
...
public final class AStarPathFinder extends PathFinder {
	...
	public Path find(Position origin, int originWidth, int originLength, Position target, int targetWidth, int targetLength) {
		...
		Position next;
		boolean found = false;
		int distance = (int) (origin.getDistance(target) * Region.SIZE);
		...
		do {
			...
			for(Direction direction : Direction.valid()) {
				...
				if(traversable(position, originWidth, direction) && traversable(next, originWidth, Direction.getOppositeDirection(direction))) {
...
final class Node implements Comparable<Node> {
	...
	public final boolean equals(Object obj) {
		...
		if(!(obj instanceof Node))
			return false;
		Node other = (Node) obj;
		return getPosition().getX() == other.getPosition().getX() && getPosition().getY() == other.getPosition().getY() && getPosition().getHeight() == other.getPosition().getHeight() && getCost() == other.getCost() && getParent().getCost() == other.getParent().getCost() && getParent().getPosition().getX() == other.getParent().getPosition().getX() && getParent().getPosition().getY() == other.getParent().getPosition().getY() && getParent().getPosition().getHeight() == other.getPosition().getHeight();
	}
