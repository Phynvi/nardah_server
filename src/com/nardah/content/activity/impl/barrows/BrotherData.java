...
public enum BrotherData {
	AHRIM(1672, new Position(3562, 3285), new Position(3568, 3291), new Position(3565, 3288), new Position(3557, 9703, 3)), GUTHAN(1674, new Position(3575, 3279), new Position(3580, 3286), new Position(3577, 3282), new Position(3534, 9704, 3)), VERAC(1677, new Position(3554, 3293), new Position(3560, 3301), new Position(3557, 3297), new Position(3578, 9706, 3)), KARIL(1675, new Position(3563, 3273), new Position(3568, 3278), new Position(3566, 3275), new Position(3546, 9684, 3)), DHAROK(1673, new Position(3573, 3295), new Position(3578, 3300), new Position(3575, 3298), new Position(3556, 9718, 3)), TORAG(1676, new Position(3551, 3279), new Position(3556, 3285), new Position(3554, 3282), new Position(3568, 9683, 3));
	
	/**
	 * The mob id of the barrows brother.
	 */
	private int npcId;
	...
	/**
	 * Gets the mob id of the barrows brother.
	 * @return the mob id of the barrows brother.
	 */
	public int getNpcId() {
		return npcId;
	}
	...
	public static BrotherData getBarrowsBrother(Mob mob) {
		for(BrotherData brother : values()) {
			if(brother.getNpcId() == mob.id) {
				return brother;
			}
