...
class BattleRealmPanel extends Activity_Panel {
	...
	public void update(BattleRealmNode node) {
		if(BattleRealm.lobby) {
			...
			setProgress((int) Utility.getPercentageAmount(com.nardah.content.activity.impl.battlerealm.BattleRealm.LOBBY_COOLDOWN - BattleRealm.getTicks(), com.nardah.content.activity.impl.battlerealm.BattleRealm.LOBBY_COOLDOWN));
		} else {
			/*
