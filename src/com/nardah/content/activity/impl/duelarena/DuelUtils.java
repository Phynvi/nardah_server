...
public final class DuelUtils {
	...
	public static boolean hasFunWeapon(Player player, Item item) {
		...
		return name.equals("fixed device") || name.contains("flowers") || name.equals("gnomeball") || name.equals("mouse toy") || name.equals("noose wand") || name.equals("pet rock") || name.equals("rat pole") || name.equals("rubber chicken") || name.equals("scythe") || name.equals("snowball") || name.equals("trollweiss") || name.equals("undead chicken") || name.equals("large spade") || name.equals("stale baguette") || name.equals("hunting knife") || name.equals("giant present") || name.equals("hand fan");
	}
