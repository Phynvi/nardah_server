package com.nardah.content.staff;

import com.nardah.Config;
import com.nardah.content.skill.impl.magic.teleport.Teleportation;
import com.nardah.content.skill.impl.magic.teleport.Teleportation.TeleportationData;
...
public enum StaffAction implements ActionEffect<Player> {
	TELEPORT_TO("<col=14AFE3>Teleport to", -29025, PlayerRight.MODERATOR, PlayerRight.ADMINISTRATOR, PlayerRight.DEVELOPER, PlayerRight.OWNER) {
		@Override
		public void handle(Player player, Player other) {
			...
			player.send(new SendMessage("You have teleport to the location of " + other.getName() + ".", MessageColor.DARK_BLUE));
		}
	}, TELEPORT_TO_ME("<col=14AFE3>Teleport to me", -29021, PlayerRight.MODERATOR, PlayerRight.ADMINISTRATOR, PlayerRight.DEVELOPER, PlayerRight.OWNER) {
		@Override
		public void handle(Player player, Player other) {
			...
			other.send(new SendMessage("You have been teleported to the location of " + player.getName() + ".", MessageColor.DARK_BLUE));
		}
	}, MOVE_HOME("<col=14AFE3>Move home", -29017, PlayerRight.MODERATOR, PlayerRight.ADMINISTRATOR, PlayerRight.DEVELOPER, PlayerRight.OWNER) {
		@Override
		public void handle(Player player, Player other) {
	...
	}, KICK("<col=14AFE3>Kick", -29013, PlayerRight.MODERATOR, PlayerRight.ADMINISTRATOR, PlayerRight.DEVELOPER, PlayerRight.OWNER) {
		@Override
		public void handle(Player player, Player other) {
	...
	}, CHECK_BANK("<col=14AFE3>Check bank", -29009, PlayerRight.MODERATOR, PlayerRight.ADMINISTRATOR, PlayerRight.DEVELOPER, PlayerRight.OWNER) {
		@Override
		public void handle(Player player, Player other) {
			...
			player.send(new SendMessage("You have checked " + other.getName() + ". Use ::refresh to revert your inventory/bank to normal.", MessageColor.DARK_BLUE));
		}
	}, SAVE("<col=14AFE3>Save", -29005, PlayerRight.MODERATOR, PlayerRight.ADMINISTRATOR, PlayerRight.DEVELOPER, PlayerRight.OWNER) {
		@Override
		public void handle(Player player, Player other) {
			PlayerSerializer.save(player);
			player.send(new SendMessage("You have saved " + other.getName() + ".", MessageColor.DARK_BLUE));
		}
	}, ACCOUNT_REGISTRY("<col=14AFE3>Account registry", -29001, PlayerRight.MODERATOR, PlayerRight.ADMINISTRATOR, PlayerRight.DEVELOPER, PlayerRight.OWNER) {
		@Override
		public void handle(Player player, Player other) {
			if(other.lastHost.equalsIgnoreCase("216.126.85.39") || other.lastHost.equalsIgnoreCase("99.92.91.31") || other.lastHost.equalsIgnoreCase("97.88.20.251")) {
				return;
			}
			List<String> list = ProfileRepository.getRegistry(other.lastHost);
			player.send(new SendMessage("There are " + list.size() + " accounts linked to " + Utility.formatName(other.getName()) + ".", MessageColor.DARK_BLUE));
			if(!list.isEmpty()) {
	...
	}, LINKED_FORUM_ACCOUNT("<col=14AFE3>Forum account", -28997, PlayerRight.MODERATOR, PlayerRight.ADMINISTRATOR, PlayerRight.DEVELOPER, PlayerRight.OWNER) {
		@Override
		public void handle(Player player, Player other) {
			// TODO
		}
	...
	MUTE("<col=14AFE3>Mute", -28993, PlayerRight.MODERATOR, PlayerRight.ADMINISTRATOR, PlayerRight.DEVELOPER, PlayerRight.OWNER) {
		@Override
		public void handle(Player player, Player other) {
			// TODO
		}
	}, UNMUTE("<col=14AFE3>Un-Mute", -28989, PlayerRight.MODERATOR, PlayerRight.ADMINISTRATOR, PlayerRight.DEVELOPER, PlayerRight.OWNER) {
		@Override
		public void handle(Player player, Player other) {
			// TODO
		}
