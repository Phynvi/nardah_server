...
public enum ClanAchievement {
	/* Easy */
	CLAN_MEMBERS_I("Have 10 members in your clan", 10, Difficulty.EASY), TASKS_I("Complete 10 clan tasks", 10, Difficulty.EASY), PLAYER_KILLER_I("Kill 25 wilderness players", 25, Difficulty.EASY),

	/* Medium */
	CLAN_MEMBERS_II("Have 50 members in your clan", 50, Difficulty.MEDIUM), TASKS_II("Complete 100 clan tasks", 100, Difficulty.MEDIUM), PLAYER_KILLER_II("Kill 150 wilderness players", 150, Difficulty.MEDIUM),

	/* Hard */
	CLAN_MEMBERS_III("Have 150 members in your clan", 150, Difficulty.HARD), TASKS_III("Complete 500 clan tasks", 500, Difficulty.HARD), PLAYER_KILLER_III("Kill 750 wilderness players", 750, Difficulty.HARD),
	;
