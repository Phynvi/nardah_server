...
public class ClanShowcase {
	...
	public void remove(Player player) {
		...
		player.dialogueFactory.sendStatement("Are you sure you want to delete <col=225>" + ItemDefinition.get(currentItem).getName() + "</col>?", "Once this action is performed it can not be undone!").sendOption("Yes", () -> {
