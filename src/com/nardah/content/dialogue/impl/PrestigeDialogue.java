...
public class PrestigeDialogue extends Dialogue {
	...
	/**
	 * The dialogue mob identification.
	 */
	...
	private void explainPrestige(DialogueFactory factory) {
		factory.sendNpcChat(POLLY, Expression.HAPPY, "The concept of prestiges is very simple!", "Once you have achieved level 99 in any non-combat", "skill, you will be permitted to prestige that skill.");
