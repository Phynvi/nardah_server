...
public class RealmLordDialogue extends Dialogue {
	...
	public void sendDialogues(DialogueFactory factory) {
		factory.sendNpcChat(15, Expression.HAPPY, "Hello adventurer, how may I help you?").sendOption("Ask about the Battle Realm", () -> explain(factory), "Join the Battle Realm", () -> enterBattleRealm(factory), "Never mind", factory::clear);
		factory.execute();
	}

	private void explain(DialogueFactory factory) {
		factory.sendNpcChat(15, "Here's an explanation on the game!", "Here's an explanation on the game!", "Here's an explanation on the game!").sendNpcChat(15, "Would you like to play?").sendOption("Yes", () -> {
