package com.nardah.content.bot.botclass.impl;
...
public class PureMelee extends SimplifiedListener<Player> implements BotClass {
	...
	public Item[] inventory() {
		return new Item[]{new Item(12695), new Item(391), new Item(391), new Item(391), new Item(3024), new Item(391), new Item(391), new Item(391), new Item(3024), new Item(391), new Item(391), new Item(391), new Item(3024), new Item(391), new Item(391), new Item(391), new Item(3024), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(13652), new Item(3144), new Item(3144), new Item(3144), new Item(3144), new Item(3144)};
	}

	@Override
	public Item[] equipment() {
		return new Item[]{new Item(662), new Item(6107), new Item(6108), new Item(3105), new Item(7458), new Item(6570), new Item(3842), new Item(2550), new Item(1725), new Item(4587)};
	}
	...
	public void endFight(PlayerBot bot) {
		bot.prayer.deactivate(Prayer.PROTECT_ITEM, Prayer.SMITE, Prayer.ULTIMATE_STRENGTH, Prayer.STEEL_SKIN, Prayer.INCREDIBLE_REFLEXES);
	}
	...
	public void hit(Player attacker, Actor defender, Hit hit) {
		...
		boolean combo = defender.getCurrentHealth() <= defender.getMaximumHealth() * RandomUtils.inclusive(0.50, 0.70) && hit.getDamage() >= max * RandomUtils.inclusive(0.65, 0.75);
	...
	public void pot(Player target, PlayerBot bot) {
		...
		} else if(checkSkill(bot, Skill.ATTACK, 71) || checkSkill(bot, Skill.STRENGTH, 115) || checkSkill(bot, Skill.DEFENCE, 3)) {
