...
public class AGSRuneMelee extends SimplifiedListener<Player> implements BotClass {
	...
	public Item[] inventory() {
		return new Item[]{new Item(12695), new Item(3024), new Item(3024), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(3144), new Item(3144), new Item(391), new Item(391), new Item(3144), new Item(3144), new Item(391), new Item(391), new Item(11802), new Item(557, 500), new Item(560, 500), new Item(9075, 500)};
	}
		...
		bot.schedule(4, () -> {
			...
			bot.schedule(4, () -> {
				if(!bot.isSpecialActivated() && bot.equipment.getWeapon().matchesId(11802)) {
					...
					idx = bot.inventory.computeIndexForId(12954);
					bot.equipment.equip(idx);
					bot.getCombat().setFightType(FightType.SCIMITAR_SLASH);
				}
			});
