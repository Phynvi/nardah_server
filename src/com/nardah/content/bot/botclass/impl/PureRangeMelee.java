...
public class PureRangeMelee extends SimplifiedListener<Player> implements BotClass {
	...
	public Item[] inventory() {
		return new Item[]{new Item(2444), new Item(12695), new Item(3144), new Item(3144), new Item(3024), new Item(3024), new Item(3144), new Item(3144), new Item(3024), new Item(3024), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(11802), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391)};
	}
	...
	public void pot(Player target, PlayerBot bot) {
		...
		if(checkSkill(bot, Skill.PRAYER, 25)) {
			...
			if(checkSkill(bot, Skill.ATTACK, 71) || checkSkill(bot, Skill.STRENGTH, 115) || checkSkill(bot, Skill.DEFENCE, 3)) {
