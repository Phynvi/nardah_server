...
public class ZerkerMelee extends SimplifiedListener<Player> implements BotClass {
	...
	public Item[] inventory() {
		return new Item[]{new Item(5698), new Item(21003), new Item(12695), new Item(3024), new Item(3024), new Item(3024), new Item(3024), new Item(3144), new Item(3144), new Item(3144), new Item(3144), new Item(3144), new Item(3144), new Item(560, 150), new Item(9075, 150), new Item(557, 300), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391)};
	}

	@Override
	public Item[] equipment() {
		return new Item[]{new Item(6570), new Item(11128), new Item(10551), new Item(3751), new Item(1079), new Item(8850), new Item(4131), new Item(2550), new Item(7462), new Item(4587)};
	}
	...
	public void pot(Player target, PlayerBot bot) {
		...
		} else if(checkSkill(bot, Skill.ATTACK, 115) || checkSkill(bot, Skill.STRENGTH, 115) || checkSkill(bot, Skill.DEFENCE, 115)) {
