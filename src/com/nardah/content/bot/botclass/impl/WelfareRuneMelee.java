...
public class WelfareRuneMelee extends SimplifiedListener<Player> implements BotClass {
	...
	public Item[] inventory() {
		return new Item[]{new Item(12695), new Item(3024), new Item(3024), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(391), new Item(3144), new Item(3144), new Item(391), new Item(391), new Item(3144), new Item(3144), new Item(391), new Item(391), new Item(5698), new Item(557, 500), new Item(560, 500), new Item(9075, 500)};
	}
	...
	public void hit(Player attacker, Actor defender, Hit hit) {
		...
		boolean combo = defender.getCurrentHealth() <= defender.getMaximumHealth() * RandomUtils.inclusive(0.50, 0.60) && hit.getDamage() >= max * RandomUtils.inclusive(0.65, 0.75);
