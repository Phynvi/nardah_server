 ...
 *
 * import QuestManager; import
 * SendFadeScreen; import
 * SendMessage; import
 * SendString; import
 * Player; import
 * DialogueFactory; import
 * NpcInteractionEvent; import
 * ObjectInteractionEvent; import
 * Quest; import
 * QuestState; import
 * RecipeForDisasterStore; import
 * World;
 *
 *//**
 ...
 * event) { if (event.getOpcode() == 0 && event.getMob().id == 6526) {
 * player.dialogueFactory.sendDialogue(this); return true; } if
 * (event.getOpcode() == 1 && event.getMob().id == 6526) { if (player.glovesTier
