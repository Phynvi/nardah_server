...
public enum PetData {
	...
	YOSHI("Yoshi", 20666, 1873) {
		...
		@Override
		public void dialogue(DialogueFactory factory) {
			factory.sendPlayerChat("Fallen God, what kind of retarded name is that. There's only the god of 'tits and wine'.");
	...
	/**
	 * The mob identification of the fucking faggot pet.
	 */
	...
	/**
	 * Gets the mob identification of the pet.
	 */
	public int getNpc() {
		return npc;
	}
	...
	/**
	 * Gets the pet data based on the given mob identification.
	 */
