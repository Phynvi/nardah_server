...
import com.nardah.content.skill.impl.magic.enchant.BoltEchantData;
import com.nardah.content.skill.impl.magic.enchant.SpellEnchant;
import com.nardah.content.skill.impl.magic.enchant.SpellEnchantData;
import com.nardah.Config;
import com.nardah.game.Graphic;
import com.nardah.game.action.impl.SpellAction;
...
public class SpellCasting {
	...
	private boolean hasEnchantRunes(int spellID) {
		...
		if(spell.getReq3() == 0) {
			return player.inventory.contains(spell.getReq1(), spell.getReqAmt1()) && player.inventory.contains(spell.getReq2(), spell.getReqAmt2()) && player.inventory.contains(spell.getReq3(), spell.getReqAmt3());
		} else {
			return player.inventory.contains(spell.getReq1(), spell.getReqAmt1()) && player.inventory.contains(spell.getReq2(), spell.getReqAmt2());
		}
	}
