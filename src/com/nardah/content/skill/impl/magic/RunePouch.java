package com.nardah.content.skill.impl.magic;
...
public class RunePouch {
	 ...
	 */
	private final Item[] ALLOWED_RUNES = {new Item(554), new Item(555), new Item(556), new Item(557), new Item(558), new Item(559), new Item(560), new Item(561), new Item(562), new Item(563), new Item(564), new Item(565), new Item(566), new Item(9075)};
	...
	public void deposit(Item item, int amount) {
		...
		if(runeAmount >= MAXIMUM_RUNE_CAPACITY) {
			player.message("You can only have a total of " + Utility.formatDigits(MAXIMUM_RUNE_CAPACITY) + " runes in your rune pouch.");
			return;
		}
