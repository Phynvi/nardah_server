...
public class Farming {
	...
	public void doConfig() {
		...
		player.send(new SendConfig(529, (config(FarmingPatches.SOUTH_FALADOR_HERB) << 24) + (config(FarmingPatches.SOUTH_FALADOR_FLOWER) << 16) + (config(FarmingPatches.SOUTH_FALADOR_ALLOTMENT_SOUTH) << 8) + (config(FarmingPatches.SOUTH_FALADOR_ALLOTMENT_WEST))));
		// old stuff
