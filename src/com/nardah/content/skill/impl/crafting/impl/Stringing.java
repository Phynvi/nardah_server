...
public class Stringing {
	...
	public enum AmuletData {
		GOLD(1673, 1692, 8), SAPPHIRE(1675, 1694, 24), EMERALD(1677, 1696, 31), RUBY(1679, 1698, 50), DIAMOND(1681, 1700, 70), DRAGONSTONE(1683, 1702, 80), ONYX(6579, 6581, 90), ZENYTE(19501, 19541, 98);
