package com.nardah.content.skill.impl.crafting.impl;
...
import com.nardah.net.packet.out.SendInterfaceConfig;
...
public final class Jewellery {
	...
	public enum JewelleryType {
		RING(4233), NECKLACE(4239), AMULET(4245);
	...
	public enum JewelleryData {
		GOLD_RING(1635, 5, 15, JewelleryType.RING, new Item(1592), new Item(2357)), SAPPHIRE_RING(1637, 20, 40, JewelleryType.RING, new Item(1592), new Item(2357), new Item(1607)), EMERALD_RING(1639, 27, 55, JewelleryType.RING, new Item(1592), new Item(2357), new Item(1605)), RUBY_RING(1641, 34, 70, JewelleryType.RING, new Item(1592), new Item(2357), new Item(1603)), DIAMOND_RING(1643, 43, 85, JewelleryType.RING, new Item(1592), new Item(2357), new Item(1601)), DRAGONSTONE_RING(1645, 55, 100, JewelleryType.RING, new Item(1592), new Item(2357), new Item(1615)), ONYX_RING(6575, 67, 85, JewelleryType.RING, new Item(1592), new Item(2357), new Item(6573)),

		GOLD_NECKLACE(1654, 6, 20, JewelleryType.NECKLACE, new Item(1597), new Item(2357)), SAPPHIRE_NECKLACE(1656, 22, 55, JewelleryType.NECKLACE, new Item(1597), new Item(2357), new Item(1607)), EMERALD_NECKLACE(1658, 29, 60, JewelleryType.NECKLACE, new Item(1597), new Item(2357), new Item(1605)), RUBY_NECKLACE(1660, 40, 75, JewelleryType.NECKLACE, new Item(1597), new Item(2357), new Item(1603)), DIAMOND_NECKLACE(1662, 56, 90, JewelleryType.NECKLACE, new Item(1597), new Item(2357), new Item(1601)), DRAGONSTONE_NECKLACE(1664, 72, 105, JewelleryType.NECKLACE, new Item(1597), new Item(2357), new Item(1615)), ONYX_NECKLACE(6577, 82, 120, JewelleryType.NECKLACE, new Item(1597), new Item(2357), new Item(6573)),

		GOLD_AMULET(1673, 8, 30, JewelleryType.AMULET, new Item(1595), new Item(2357)), SAPPHIRE_AMULET(1675, 24, 65, JewelleryType.AMULET, new Item(1595), new Item(2357), new Item(1607)), EMERALD_AMULET(1677, 31, 61, JewelleryType.AMULET, new Item(1595), new Item(2357), new Item(1605)), RUBY_AMULET(1679, 50, 85, JewelleryType.AMULET, new Item(1595), new Item(2357), new Item(1603)), DIAMOND_AMULET(1681, 70, 100, JewelleryType.AMULET, new Item(1595), new Item(2357), new Item(1601)), DRAGONSTONE_AMULET(1683, 80, 125, JewelleryType.AMULET, new Item(1595), new Item(2357), new Item(1615)), ONYX_AMULET(6579, 90, 150, JewelleryType.AMULET, new Item(1595), new Item(2357), new Item(6573));
