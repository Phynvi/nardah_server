...
public class Glass {
	...
	public enum GlassData {
		VIAL(229, 33, 35.0D, 1775), LIGHT_ORB(10973, 87, 70.0D, 1775), BEER_GLASS(1919, 1, 17.5D, 1775), CANDLE_LANTERN(4527, 4, 19.0D, 1775), OIL_LAMP(4522, 12, 25.0D, 1775), FISHBOWL(6667, 42, 42.5D, 1775), LANTERN_LENS(4542, 49, 55.0D, 1775), MOLTEN_GLASS(1775, 1, 20.0D, 1781), UNPOWDERED_ORD(567, 46, 52.5D, 1775);
	...
	public static boolean click(Player player, int button) {
		switch(button) {
			...
			case 11472:
				...
				return true;
			case 11471:
				player.send(new SendInputAmount("Enter the amount you would like to craft", 2, input -> craft(player, GlassData.VIAL, Integer.parseInt(input))));
				return true;
			/** Orb */
			case 12396:
				craft(player, GlassData.UNPOWDERED_ORD, 1);
				return true;
			case 12395:
				craft(player, GlassData.UNPOWDERED_ORD, 5);
				return true;
			case 12394:
				craft(player, GlassData.UNPOWDERED_ORD, 10);
				return true;
			case 11475:
				player.send(new SendInputAmount("Enter the amount you would like to craft", 2, input -> craft(player, GlassData.UNPOWDERED_ORD, Integer.parseInt(input))));
				return true;
			/** Beer glass */
			case 12400:
			...
			case 12398:
				...
				return true;
			case 12397:
				player.send(new SendInputAmount("Enter the amount you would like to craft", 2, input -> craft(player, GlassData.BEER_GLASS, Integer.parseInt(input))));
				return true;
			/** Candle lantern */
			case 12404:
			...
			case 12402:
				...
				return true;
			case 12401:
				player.send(new SendInputAmount("Enter the amount you would like to craft", 2, input -> craft(player, GlassData.CANDLE_LANTERN, Integer.parseInt(input))));
				return true;
			/** Oil lamp */
			case 12408:
			...
			case 12406:
				...
				return true;
			case 12405:
				player.send(new SendInputAmount("Enter the amount you would like to craft", 2, input -> craft(player, GlassData.OIL_LAMP, Integer.parseInt(input))));
				return true;
			/** Fishbowl */
			case 6203:
			...
			case 6201:
				...
				return true;
			case 6200:
				player.send(new SendInputAmount("Enter the amount you would like to craft", 2, input -> craft(player, GlassData.FISHBOWL, Integer.parseInt(input))));
				return true;
			/** Lantern lens */
			case 12412:
			...
			case 12410:
				...
				return true;
			case 12409:
				player.send(new SendInputAmount("Enter the amount you would like to craft", 2, input -> craft(player, GlassData.LANTERN_LENS, Integer.parseInt(input))));
				return true;
		}
		return false;
	}
