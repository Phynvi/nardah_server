...
import com.nardah.net.packet.out.SendItemOnInterfaceZoom;
...
public class Tanning {
	 ...
	 */
	public enum TanData {
		LEATHER(1739, 1741, 1), HARD_LEATHER(1739, 1743, 3), SNAKE_HIDE(6287, 6287, 15), SNAKESKIN(6287, 6289, 20), GREEN_LEATHER(1753, 1745, 20), BLUE_LEATHER(1751, 2505, 20), RED_LEATHER(1749, 2507, 20), BLACK_LEATHER(1747, 2509, 20);
	...
	public static void tan(Player player, int amount, TanData data) {
		...
		player.send(new SendMessage("You successfully tan all the " + ItemDefinition.get(data.ingredient).getName() + " for " + amount + " coins."));
	}
