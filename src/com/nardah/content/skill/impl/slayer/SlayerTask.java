...
public enum SlayerTask implements TaskInterface<Player> {
	// GOBLIN("Goblin", 2, 300, TaskDifficulty.EASY, new Position(1, 1),
	// "Lumbridge", 655, 656, 657, 658, 659, 660, 661, 662, 663, 664, 665, 666, 667,
	// 668) {
	//        @Override
	...
	}, CRAWLING_HAND("Crawling hand", 1, 375, TaskDifficulty.EASY, new Position(1, 1), "Slayer Tower", 120, 448, 449, 450, 451, 452, 453, 454, 455, 456, 457) {
		@Override
		public boolean canAssign(Player player) {
			return true;
		}
	...
	//        }
	//    },
	FIRE_GIANT("Fire giant", 5, 150, TaskDifficulty.MEDIUM, new Position(1, 1), "Slayer Cave", 2075, 2076, 2077, 2078, 2079, 2080, 2081, 2082, 2083, 2084) {
				@Override
				public boolean canAssign(Player player) {
					return true;
				}
			...
			}, GREEN_DRAGON("Green Dragon", 5, 150, TaskDifficulty.MEDIUM, new Position(1, 1), "Chaos Tunnels", 2918, 260, 261, 262, 263, 264) {
		@Override
		public boolean canAssign(Player player) {
			return true;
		}
	...
	}, INFERNAL_MAGES("Infernal mage", 45, 150, TaskDifficulty.MEDIUM, new Position(1, 1), "Pollnivneach Well Dungeon", 443, 444, 445, 446, 447) {
		@Override
		public boolean canAssign(Player player) {
			return true;
		}
	...
	}, DUST_DEVILS("Dust devil", 65, 150, TaskDifficulty.MEDIUM, new Position(1, 1), "Pollnivneach Smoke Dungeon", 423, 424) {
		@Override
		public boolean canAssign(Player player) {
			return true;
		}
	...
	}, ABERRANT_SPECTRES("Aberrant Spectres", 60, 150, TaskDifficulty.MEDIUM, new Position(1, 1), "Slayer Tower", 2, 3, 4, 5, 6, 7) {
		@Override
		public boolean canAssign(Player player) {
			return true;
		}
	...
	}, ANKOU("Ankou", 1, 300, TaskDifficulty.HARD, new Position(1, 1), "Stronghold of Security", 2514, 2515, 2516, 2517, 2518, 2519) {
		@Override
		public boolean canAssign(Player player) {
			return true;
		}
	...
	}, BLACK_DEMONS("Black demon", 1, 300, TaskDifficulty.HARD, new Position(1, 1), "Taverly Dungeon", 240, 2052, 2048, 2049, 2051, 2050) {
		@Override
		public boolean canAssign(Player player) {
			return true;
		}
	...
	}, DAGANNOTHS("Dagannoth", 1, 375, TaskDifficulty.HARD, new Position(1, 1), "Fremennik Province Light House", 3185, 970, 971, 972, 973, 974, 975, 976, 977, 978, 979, 980, 981, 982, 983, 984, 985, 986, 987, 988, 2250, 2251, 2252, 2253, 2254, 2255, 2256, 2257, 2258, 2259, 2265, 2266, 2267) {
		@Override
		public boolean canAssign(Player player) {
			return true;
		}
	...
	}, BLUE_DRAGONS("Blue Dragon", 1, 150, TaskDifficulty.MEDIUM, new Position(1, 1), "Taverly Dungeon", 268, 269, 241, 4385, 5878, 5879, 5880, 5881, 5882) {
		@Override
		public boolean canAssign(Player player) {
			return true;
		}
	...
	//        }
	//    },
	SKELETAL_WYVERN("Skeletal wyvern", 72, 50, TaskDifficulty.HARD, new Position(1, 1), "Asgarnia Ice Dungeon", 465, 466, 467, 468) {
				@Override
				public boolean canAssign(Player player) {
	...
	}, KRAKEN("Kraken", 87, 50, TaskDifficulty.BOSS, new Position(1, 1), "Kraken cave", 494, 5535) {
		@Override
		public boolean canAssign(Player player) {
	 ...
	 */
	SlayerTask(String name, int level, int size, TaskDifficulty difficulty, Position position, String locationString, int... npc) {
		this.name = name;
		this.level = level;
		this.size = size;
	...
	/**
	 * Gets the display size of the mob.
	 */
	public int getSize() {
		return size;
	}
	...
	/**
	 * Gets the combat level of the mob.
	 */
	public int getCombatLevel() {
		return MobDefinition.get(npc[0]).getCombatLevel();
	}

	/**
	 * Checks if the mob is a slayer task assignment.
	 */
