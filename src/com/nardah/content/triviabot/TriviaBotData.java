...
public enum TriviaBotData {
	_1("What is 521+412", "933"),
	_2("Name one game developer.", "Rogue", "Ethan"),
	...
	_10("What is the URL of our forums?", "nardah.com", "www.nardah.com", "http://www.nardah.com"),
	_11("What server is dope af?", "Nardah", "nardah"),
	_12("What is the location name of home?", "edgeville"),
	_13("Name one of the rare drops that General Gaardoor drops.", "bandos tasset", "bandos boots", "bandos chestplate", "bandos hilt", "godsword shard", "bandos tassets"),
	...
	_72("What is the max damage of a single hit of the Dark bow's special attack?", "48", "fourty eight", "fourty-eight"),
	...
	_124("How many Hitpoints do Sharks heal?", "20", "Twenty", "200", "two hundred"),
	_125("How many partyhats are in a set?", "6", "six"),
	_126("How many PKPs do you need to buy a Mystery box from Mandrith?", "8", "eight"),
	_127("How many waves are there in a Challenge scroll?", "12", "twelve"),
	...
	_137("What monster drops Promethium armour?", "avatar of creation"),
	_138("What monster drops Primal armour?", "avatar of destruction"),
	_139("How many dollars do you have to donate to become a Legendary Donator?", "1000", "one thousand"),
	_140("How many dollars do you have to donate to become a Respected Donator?", "300", "three hundred"),
	_141("How many dollars do you have to donate to become a Super Donator?", "50", "fifty"),
	_142("How many dollars do you have to donate to gain access to Donator Island?", "25", "twenty five"),
	...
	_146("Which godswords special attack freezes your enemy?", "zamorak godsword"),
	...
	_149("How many trainable skills are there in Nardah?", "22"),
	...
	_161("What level wild is the nomad at?", "54", "fifty four"),
	_162("What monster drops steadfast, glaiven and ragefire boots?", "nomad"),
	_163("What is the clanchat name for buying/selling?", "nr market"),
	_164("What city is ::trade located in?", "falador"),
	_165("How many moles are located near the mage arena?", "3", "three"),
	_166("In which city is a zoo located?", "ardougne"),
	_167("What cape does plane-freezer lakhrahnaz drop?", "spirit", "spirit cape"),
	...
	_171("What whip is an orange color?", "lava", "lava whip"),
	_172("What item for slayer helm do you get from cave horrors?", "black mask"),
	_173("Who sells lottery tickets?", "lottie"),
	_174("Who sells titles for loyalty points?", "ringmaster"),
	...
	_185("With what percentage does a drop rate box increase your drop rate?", "15", "fifteen", "15%"),
	_186("How many coins is a note worth?", "500000000", "500m"),
	...
	_189("What mob gives you a starter kit?", "fat tony"),
	_190("How many coins does a lottery ticket cost?", "5m", "five million", "5000000"),
	_191("How many Hitpoints do Sharks heal?", "20", "Twenty", "200", "two hundred"),
	_192("What Magic level is needed to cast Ice Barrage?", "94"),
	_193("What is the highest tier defender?", "dragon", "dragon defender"),
	_194("What is the required Attack level needed to wield the Abyssal whip?", "70", "seventy"),
	_195("What is the required Strength level needed to wield the Tzhaar-ket-om?", "60", "sixty"),
	_196("What is the required Ranged level needed to wield Red chinchompas?", "55", "fifty five"),
	_197("How many charges can an amulet of glory hold?", "6", "six"),
	_198("What herb is required to make a Prayer potion?", "ranarr"),
	_199("The Amulet of fury is created using which gem?", "onyx"),
	_200("How many types of godswords are there?", "4", "four"),
	_201("What is the Prayer requirement needed to wield the Elysian spirit shield?", "75", "seventy five"),
	_202("What ore can be mined at level 70 Mining?", "adamantite", "adamantite ore", "adamamant ore"),
	_203("Which godsword has the strongest special attack in PvP?", "armadyl godsword"),
	_204("Which godswords special attack can heal you?", "saradomin godsword"),
	_205("Which godswords special attack drains your opponents stats?", "bandos godsword"),
