...
public class BronzeMysteryBox extends MysteryBox {
    ...
    protected Chance<Item> rewards() {
        ...
        rewards.add(COMMON, new Item(995, 2500000)); // COINS
        rewards.add(COMMON, new Item(392, 100)); // MANTA_RAY
        rewards.add(COMMON, new Item(12696, 20)); // SUPER_COMABT_POTION_(4)
        rewards.add(UNCOMMON, new Item(4207, 1)); // CRYSTAL_SEED
        rewards.add(UNCOMMON, new Item(10551, 1)); // FIGHTER_TORSO
        rewards.add(UNCOMMON, new Item(6570, 1)); // FIRE_CAPE
        rewards.add(RARE, new Item(4151, 1)); // ABYSSAL_WHIP
        rewards.add(COMMON, new Item(11840, 1)); // DRAGON_BOOTS
        rewards.add(RARE, new Item(12877, 1)); // DHAROKS_SET
        rewards.add(RARE, new Item(12881, 1)); // AHRIMS_SET
        rewards.add(RARE, new Item(12875, 1)); // VERACS_SET
        rewards.add(RARE, new Item(12873, 1)); // GUTHANS_SET
        rewards.add(RARE, new Item(12879, 1));// TORAGS_SET
        rewards.add(RARE, new Item(12883, 1)); // KARILS_SET
        rewards.add(COMMON, new Item(11738, 5)); // HERB_BOX
        rewards.add(UNCOMMON, new Item(537, 50)); // DRAGON_BONES
        rewards.add(COMMON, new Item(3140, 1)); // DRAGON_CHAINBODY
        rewards.add(UNCOMMON, new Item(6739, 1)); // DRAGON_AXE
        rewards.add(UNCOMMON, new Item(6889, 1)); // MAGES_BOOK
        rewards.add(RARE, new Item(19722, 1)); // DRAGON_DEFENDER_(T)
        rewards.add(COMMON, new Item(2435, 50)); // PRAYER_POTION_(4)
