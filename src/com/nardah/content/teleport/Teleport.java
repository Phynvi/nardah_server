...
public enum Teleport {
	...
	/* CITIES */
	VARROCK("Varrock", TeleportType.CITIES, new Position(3210, 3424, 0), false, new int[]{8007, 8007, 8007}, true, "The pretty city by the name of Varrock", "Where the markets are filled with goods"), LUMBRIDGE("Lumbridge", TeleportType.CITIES, new Position(3222, 3218, 0), false, new int[]{8008, 8008, 8008}, true, "A once dangerous land", " but now home to the king of lumbridge!"), ALKHARID("Al Kharid", TeleportType.CITIES, new Position(3275, 3166, 0), false, new int[]{1833, 1835, 1837}, true, "Home to the arabs and their spices!", ""), CAMELOT("Camelot", TeleportType.CITIES, new Position(2757, 3477, 0), false, new int[]{8010, 8010, 8010}, true, "Camelot, alot to do, alot to accomplish in this area.", ""), CATHERBY("Catherby", TeleportType.CITIES, new Position(2804, 3435, 0), false, new int[]{-1, 11995}, true, "Catherby is considered the fishing town of Nardah", ""), DRAYNOR("Draynor", TeleportType.CITIES, new Position(3104, 3248, 0), false, new int[]{19615, 19615, 19615}, true, "Draynor is a town that is extremely useful for you crafters!", ""), PORTSARIM("Port Sarim", TeleportType.CITIES, new Position(3019, 3217, 0), false, new int[]{272, 307, 10136}, true, "The capital of all fishing villages", " has the largest exports of exotic rare fishes!"), TREEGNOMESTRONGHOLD("Gnome Stronghold", TeleportType.CITIES, new Position(2440, 3403, 0), false, new int[]{3257, 9470, 13655}, true, "The gnome's hold these lands", ""),
