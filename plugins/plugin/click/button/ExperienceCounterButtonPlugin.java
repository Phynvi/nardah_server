...
public class ExperienceCounterButtonPlugin extends PluginContext {
	...
	protected boolean onClick(Player player, int button) {
		...
		case 475:
			...
			return true;
		case 476:
			player.dialogueFactory.sendStatement("Are you sure you want to do this?", "This action can not be undone!")
					.sendOption("Reset EXP counter", () -> {
					...
					}, "Nevermind", () -> player.dialogueFactory.onAction(() -> player.dialogueFactory.clear()))
					.execute();
			return true;
		case 477:
