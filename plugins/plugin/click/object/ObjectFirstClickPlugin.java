...
import com.nardah.game.action.impl.DoorAction;
import com.nardah.game.action.impl.LadderAction;
import com.nardah.game.action.impl.LeverAction;
import com.nardah.game.event.impl.ObjectClickEvent;
import com.nardah.game.plugin.PluginContext;
import com.nardah.game.task.impl.ChopVineTask;
import com.nardah.game.task.impl.ObjectReplacementEvent;
import com.nardah.game.task.impl.SteppingStoneTask;
	...
	protected boolean firstClickObject(Player player, ObjectClickEvent event) {
		...
		switch (id) {
			case 11834:
				...
				FightCaves activity = Activity.search(player, FightCaves.class).get();
				activity.finish();
				break;
		case 27215: {
