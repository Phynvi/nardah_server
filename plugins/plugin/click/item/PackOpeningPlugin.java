...
public class PackOpeningPlugin extends PluginContext {
	public enum PackData {
		...
		WATER_FILLED_VIAL_PACK(11879, new Item(228, 100)), FEATHER_PACK(11881, new Item(314, 100)),
		BAIT_PACK(11883, new Item(313, 100)), SOFT_CLAY_PACK(12009, new Item(1762, 100)),
		BROAD_ARROWHEAD_PACK(11885, new Item(11874, 100)), AIR_RUNE_PACK(12728, new Item(556, 100)),
		WATER_RUNE_PACK(12730, new Item(555, 100)), EARTH_RUNE_PACK(12732, new Item(557, 100)),
		FIRE_RUNE_PACK(12734, new Item(554, 100)), MIND_RUNE_PACK(12736, new Item(558, 100)),
		CHAOS_RUNE_PACK(12738, new Item(562, 100)), BIRD_SNARE_PACK(12740, new Item(10007, 100)),
		BOX_SNARE_PACK(12742, new Item(10009, 100)), MAGIC_BOX_PACK(12744, new Item(10026, 100)),
	...
	protected boolean firstClickItem(Player player, ItemClickEvent event) {
		...
		player.send(new SendMessage("You successfully open the " + event.getItem().getName() + "."));
		return true;
	}
}
